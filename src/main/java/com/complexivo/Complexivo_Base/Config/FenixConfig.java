...
@EnableJpaRepositories(
        ...
        basePackages = {"com.complexivo.Complexivo_Base.Repository.secondary"})
public class FenixConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorySecondary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.complexivo.Complexivo_Base.Models.secondary")// La ubicación de la clase de entidad
