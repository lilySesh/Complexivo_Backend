...
@EnableJpaRepositories(
        ...
        basePackages = {"com.complexivo.backend_distributivo.repository.secondary"})
public class FenixConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorySecondary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.complexivo.backend_distributivo.model.secondary")// La ubicación de la clase de entidad
